...
case 'menu':
sendBimg(from, `${logo}`, menu(p, botName, emoji, emoji2, status, dev, pushname, base, baileys, sender), "🤍Johnny", [
...
try {
ppimg = await conn.profilePictureUrl(`https://i.ibb.co/Pj94YN6/d86e2a6a6560350cc01ce269f7fdbdfd-waifu2x-art-noise3-scale.png`, 'image')
} catch {
ppimg = 'https://i.ibb.co/Pj94YN6/d86e2a6a6560350cc01ce269f7fdbdfd-waifu2x-art-noise3-scale.png'
}
const creditoos = `
      *《 CRIADOR DO BOT 》*
┎┳━┅┅┄┈┄✧┈┈✦❖✦
